...
/**
 * RIL customization for v521
 */

public class V521RIL extends RIL {
    static final String LOG_TAG = "V521RIL";
    ...
    public V521RIL(Context context, int preferredNetworkType, int cdmaSubscription) {
        this(context, preferredNetworkType, cdmaSubscription, null);
    }

    public V521RIL(Context context, int preferredNetworkType,
